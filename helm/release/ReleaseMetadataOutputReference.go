...
func (r *jsiiProxy_ReleaseMetadataOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_ReleaseMetadataOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
