...
func NewReleaseSetSensitiveOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ReleaseSetSensitiveOutputReference {
	...
	if err := validateNewReleaseSetSensitiveOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_ReleaseSetSensitiveOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_ReleaseSetSensitiveOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
