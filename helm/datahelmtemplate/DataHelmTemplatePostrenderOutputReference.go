...
func (d *jsiiProxy_DataHelmTemplatePostrenderOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataHelmTemplatePostrenderOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
