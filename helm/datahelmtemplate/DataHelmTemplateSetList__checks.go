...
func (d *jsiiProxy_DataHelmTemplateSetList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataHelmTemplateSetList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
