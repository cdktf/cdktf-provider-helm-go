...
import (
	...
	"github.com/cdktf/cdktf-provider-helm-go/helm/v10/provider/internal"
...
func (h *jsiiProxy_HelmProvider) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (h *jsiiProxy_HelmProvider) ToHclTerraform() interface{} {
	var returns interface{}
